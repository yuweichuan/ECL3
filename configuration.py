...
conf = {'data_path': [r"C:\Users\zhouc\Desktop\cleavable_data_demo1.mzXML",
                      r"C:\Users\zhouc\Desktop\cleavable_data_demo2.mzXML"],
        'thread': 8,
        'parse_rule': 'trypsin',  # 'arg-c', 'asp-n', 'pepsin ph1.3', 'pepsin ph2.0' etc.
        'fasta_path': "BSA.fasta",  # path to your fasta file
        'activation_type': ['HCD', 'ETD'],  # ['HCD', 'ETD'] or ['CID', 'ETD']
